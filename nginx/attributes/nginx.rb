...
default[:nginx][:ssl_ciphers] = nil # rely on default provided by nginx
default[:nginx][:force_ssl] = false # Force HTTP to redirect to HTTPS
default[:nginx][:ssl_prefer_server_ciphers] = nil
default[:nginx][:ssl_session_cache] = nil
default[:nginx][:ssl_session_timeout] = nil
default[:nginx][:ssl_dhparam] = nil
